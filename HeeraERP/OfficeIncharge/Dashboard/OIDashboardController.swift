...
class OIDashboardController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    var cellImages = ["ic_reset_password","ic_my_profile","ic_my_account","ic_tcn_request","ic_tcn_application","ic_contact_admin","ic_reset_password","ic_change_password"]
    var sideLabels = ["Add Member" ,"Members" ,"Member's Account","TCN Request","TCN Application","Redeem Details","Reset Member Password", "Change Password"]
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case 0:
            ...
            viewController = self.storyboard?.instantiateViewController(withIdentifier: "OIAddMemberController") as! OIAddMemberController
            break
        case 1:
            //**** switch view to MemberMyProfileController
            viewController = self.storyboard?.instantiateViewController(withIdentifier: "OIMembersController") as! OIMembersController
            break
        case 2:
            //**** switch view to MemberMyProfileController
            viewController = self.storyboard?.instantiateViewController(withIdentifier: "OIMembersAccountController") as! OIMembersAccountController
            break
        case 3:
        ...
        case 5:
            //switch view to MemberTcnApplicationController
            viewController = self.storyboard?.instantiateViewController(withIdentifier: "OIRedeemDetailsController") as! OIRedeemDetailsController
            break
        case 6:
            //switch view to MemberTcnApplicationController
