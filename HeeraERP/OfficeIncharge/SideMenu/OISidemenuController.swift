...
class OISidemenuController: UITableViewController {
    ...
    var sideLabels = ["Dashboard","Add Member" ,"Members" ,"Member's Account","TCN Request","TCN Application","Redeem Details","Reset Member Password", "Change Password", "Logout","blankCell"]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        //**** assign member name and photo
        lbl_memberName.text = GlobalValues.MyVariables.userName
        img_userphoto.image = #imageLiteral(resourceName: "userIcon")
    }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            ...
            controller = self.storyboard?.instantiateViewController(withIdentifier: "OfficeDashboardController")
        case 1:
            //**** switch view to MemberDashboardController
            controller = self.storyboard?.instantiateViewController(withIdentifier: "OIAddMemberController")
        case 2:
            //**** switch view to MemberDashboardController
            controller = self.storyboard?.instantiateViewController(withIdentifier: "OIMembersController")
        case 3:
            //**** switch view to MemberDashboardController
            controller = self.storyboard?.instantiateViewController(withIdentifier: "OIMembersAccountController")
        case 4:
        ...
        case 6:
            //**** switch view to MemberDashboardController
            controller = self.storyboard?.instantiateViewController(withIdentifier: "OIRedeemDetailsController")
        case 7:
            //**** switch view to MemberDashboardController
